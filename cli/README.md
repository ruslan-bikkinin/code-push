...
The update to version 2.0.0.0 saw the removal of the `app transfer` commmand. You may still transfer ownership of your applications by managing it through an organization. This requires that you visit [Mobile Center](https://mobile.azure.com) and execute a few steps.
